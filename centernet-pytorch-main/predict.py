...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/home/zhaojiankuo/centernet-pytorch-main/img/"
    dir_save_path   = "/home/zhaojiankuo/centernet-pytorch-main/img_out/"
    #-------------------------------------------------------------------------#
    #   heatmap_save_path   热力图的保存路径，默认保存在model_data下
    #   
    #   heatmap_save_path仅在mode='heatmap'有效
    #-------------------------------------------------------------------------#
    heatmap_save_path = "/home/zhaojiankuo/centernet-pytorch-main/model_data/heatmap_vision.png"
    #-------------------------------------------------------------------------#
    #   simplify            使用Simplify onnx
    #   onnx_save_path      指定了onnx的保存路径
    #-------------------------------------------------------------------------#
    simplify        = True
    onnx_save_path  = "/home/zhaojiankuo/centernet-pytorch-main/model_data/models.onnx"
    ...
    if mode == "predict":
        ...
        while True:
            # /home/zhaojiankuo/centernet-pytorch-main/img/BP01PHOTO20240312-094835.jpg
            # input('Input image filename:')
            img = '/home/zhaojiankuo/centernet-pytorch-main/img/BP01PHOTO20240312-094839.jpg'
            try:
                image = Image.open(img)
            except:
                print('Open Error! Try again!')
