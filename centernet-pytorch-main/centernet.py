...
class CenterNet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/data/zjk_weights/centernet/ep150-loss1.061-val_loss1.134.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font = ImageFont.truetype(font='/home/zhaojiankuo/centernet-pytorch-main/model_data/simhei.ttf', size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
