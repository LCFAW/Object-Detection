...
parser.add_argument('--dataset', default='Trail_knots', choices=['VOC', 'COCO','Trail_knots'],
                    type=str, help='VOC or COCO')
parser.add_argument('--dataset_root', default='/data/Trail_knots',
...
parser.add_argument('--save_folder', default='/home/zhaojiankuo/ssd.pytorch-master/weights/',
...
def train():
    ...
    elif args.dataset == 'Trail_knots':
        # if args.dataset_root == FIRE_ROOT:
        # parser.error('Must specify dataset if specifying dataset_root')
        cfg = Trail_knots
        # print(cfg)
        dataset = TrailDetection(root=args.dataset_root,
                                transform=SSDAugmentation(cfg['min_dim'],
                                                         MEANS))
