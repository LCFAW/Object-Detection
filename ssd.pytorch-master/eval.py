...
from data import Trail_ROOT, TrailAnnotationTransform, TrailDetection, BaseTransform
...
parser.add_argument('--voc_root', default=Trail_ROOT,
...
if __name__ == '__main__':
    ...
    # load data
    dataset = TrailDetection(args.voc_root, [('2007', set_type)],
                           BaseTransform(512, dataset_mean),
                           TrailAnnotationTransform())
    if args.cuda:
        net = net.cuda()
